...
export default function DisconnectTwitterModal({
  ...
  return (
    ...
    >
      <div
        ref={modalRef}
        className="relative bg-gray-100 rounded-3xl max-w-[360px] w-full shadow-2xl overflow-hidden animate-fadeIn font-nunito"
        style={{
          animation:
      ...
      >
        ...
        <div className="p-6">
          ...
          <div className="flex gap-2">
            <button
              onClick={onClose}
              className="w-full py-2.5 rounded-xl font-medium text-gray-900 text-sm bg-white cursor-pointer flex flex-col items-center hover:bg-gray-50 hover:scale-105 duration-75"
            >
            ...
            >
              ...
              <p className="text-xs font-bold">Déconnecter</p>
            </button>
          </div>
        </div>
      </div>
